...
{
    public class GetShopList3Controller : ApiController
    {
        // GET: api/GetShopList3
        public JObject Get(string rc_id)
        {
            ...
            MySqlCommand mySqlCommand = MySQL.getSqlCommand("SELECT order_number FROM orderform_1 WHERE group_number = " + number.ToString() + " and rc_id = '" + rc_id + "' and p_single = 0", mysql);
            mysql.Open();//开启数据库连接
        ...
        // GET: api/GetShopList3/5
        public string Get(int id)
        {
            return "value";
        }

        // POST: api/GetShopList3
        public void Post([FromBody]string value)
        {
        }

        // PUT: api/GetShopList3/5
        public void Put(int id, [FromBody]string value)
        {
        }

        // DELETE: api/GetShopList3/5
